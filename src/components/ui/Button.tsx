...
export default function Button({
  ...
  const variants = {
    ...
    outline:
      "bg-transparent text-blue-600 hover:bg-blue-50 focus:ring-blue-500 border border-blue-200",
    ghost:
      "bg-transparent text-slate-500 hover:bg-slate-100 hover:text-slate-700 focus:ring-slate-300",
    danger:
