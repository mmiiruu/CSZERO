  ...
  return (
    <div className="min-h-screen py-20 px-4 bg-slate-50 dark:bg-slate-900">
      <div className="max-w-4xl mx-auto">
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl text-red-600 dark:text-red-400 text-sm text-center max-w-md mx-auto">{error}</div>
        )}
        {success && (
          <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl text-green-600 dark:text-green-400 text-sm text-center max-w-md mx-auto animate-scale-in">✓ {success}</div>
        )}
        ...
        {hasVoted && <p className="text-center text-slate-400 dark:text-slate-500 text-sm mt-8">Thank you for voting! Results will be announced at the next meeting.</p>}
      </div>
    </div>
  );
}
