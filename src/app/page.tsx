    ...
    <div className="relative">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 grid-pattern">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center animate-fade-in">
          ...
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter text-slate-900 dark:text-white">
            {hero.title}
          </h1>
      ...
      <section className="py-24 px-4 bg-white dark:bg-slate-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-white">{eventsSection.title}</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <Link href={cs101Card.href} className="group active:scale-[0.995] transition-transform duration-100">
            ...
            <Link href={hwCard.href} className="group active:scale-[0.995] transition-transform duration-100">
              <div className="relative overflow-hidden bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 h-full hover:shadow-lg hover:border-purple-200 dark:hover:border-purple-700 transition-all duration-300">
                <div className="absolute top-0 right-0 w-32 h-32 bg-purple-100/50 dark:bg-purple-800/30 rounded-full blur-2xl transform translate-x-8 -translate-y-8 group-hover:scale-150 transition-transform duration-500 will-change-transform" />
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                    <span>{eventsSection.learnMoreLabel}</span>
                    <svg aria-hidden="true" className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
      ...
      <section className="py-20 px-4 bg-slate-50 dark:bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-white">{teamSection.title}</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {teamSection.preview.map((member, i) => (
              <div key={i} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 text-center hover:shadow-md hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-300 group">
                ...
                {/* text-slate-500/400 maintains WCAG AA contrast on white/slate-800 */}
      ...
      <section className="pt-24 pb-32 px-4 bg-white dark:bg-slate-900 border-b border-transparent">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-white mb-6">{cta.title}</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link href={cta.secondaryButton.href} className="px-10 py-4 bg-white dark:bg-slate-800/80 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 rounded-xl font-medium hover:bg-slate-50 dark:hover:bg-slate-700 active:scale-[0.98] transition-all duration-200 text-base w-full sm:w-auto text-center shadow-md">
