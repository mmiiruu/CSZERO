    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <section className="relative py-32 px-4 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            ...
            <a href="#schedule" className="px-8 py-3.5 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-xl font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-200 text-sm text-center">
              View Schedule
            </a>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-slate-50 dark:bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-800 dark:text-white mb-12 text-center">Why CS101?</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 hover:shadow-md hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-300">
      ...
      <section id="schedule" className="py-20 px-4 bg-white dark:bg-slate-900">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-mono text-blue-500 dark:text-blue-400 uppercase tracking-widest mb-3">agenda</p>
            <h2 className="text-3xl font-bold text-slate-800 dark:text-white">Schedule</h2>
          </div>
      ...
      <section className="py-20 px-4 bg-slate-50 dark:bg-slate-800/50">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-slate-800 dark:text-white mb-4">Ready to start your CS journey?</h2>
          <p className="text-slate-500 dark:text-slate-400 mb-8">Limited spots available. Register now to secure your place.</p>
