    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-purple-50 to-white dark:from-slate-900 dark:to-slate-900">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white animate-pulse">Sorting...</h2>
          <p className="text-slate-500 dark:text-slate-400 mt-2">Finding your house</p>
        </div>
      </div>
    );
  }
